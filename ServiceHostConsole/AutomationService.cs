...
namespace ServiceHostConsole
{
    ...
    [ServiceContract]
    partial class AutomationService : ServiceBase
    {
        ...
        [OperationContract]
        [WebGet(UriTemplate = "nodes/", BodyStyle = WebMessageBodyStyle.Bare)]
        public Stream viewNodes()
        {
            ...
            return wrapHtmlOutput("Automation Nodes ", sb.ToString());

        }

        private void renderAutomationNode(XmlNode automationNode, HtmlTextWriter rs)
        {
